...
RSpec.describe "Form submission for migrating baldwin", type: :system, mock_ezid_api: true, js: true do
  ...
  context "migrate record from dataspace" do
    it "produces and saves a valid datacite record" do
      ...
      find("tr:last-child input[name='creators[][orcid]']").set "0000-0002-4174-2743"
      ...
      find("tr:last-child input[name='creators[][orcid]']").set "0000-0003-0053-7409"
      ...
      click_on "Add Another Creator"
      find("tr:last-child input[name='creators[][orcid]']").set "0000-0002-5085-224X"
      ...
      click_on "Add Another Creator"
      find("tr:last-child input[name='creators[][orcid]']").set "0000-0002-9708-5914"
      ...
      click_on "Add Another Creator"
      find("tr:last-child input[name='creators[][orcid]']").set "0000-0003-0657-3515"

    ...
    private
      ...
      def notification_for_transition
        ...
        when :awaiting_approval
          "#{user_tags} The [#{work_title}](#{work_url}) is ready for review."
        when :draft
          "#{user_tags} The [#{work_title}](#{work_url}) has been created."
        when :approved
          "#{user_tags} The [#{work_title}](#{work_url}) has been approved."
        end
      end
